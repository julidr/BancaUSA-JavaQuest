...
<body>	
    ...
    <div id = "head">
      ...
      <ul class="nav nav-pills">
          <li role="presentation" class="active"><a href="pagoTarjeta.php"><img src="ui/Img/pago.png" id="icons">&nbsp Pago de Tarjetas</a></li>
	...
	<div id="contenido">
		<div id="der2.1">
         <h3 id="titulo">Pago De Tarjetas</h3>
        
         <br>
         <fieldset id="consign">
         <form id="consignaForm" name="consignaForm"role="form" method="Post" action="ui/php/transaccion/tarjeta.php">
          <fieldset>
            <legend>Pago Tarjeta</legend>
            <?php
            ...
            echo "</select>"; 
                          ?>
                <br>
    			   <label id="lc" >Numero de Tarjeta:</label>
             ...
             <input type="password"class="form-control" id="clave" name="clave" placeholder="Ex: 100000">

...
<body>	
      ...
      <ul class="nav nav-pills">
          <li role="presentation" class="active"><a href="pagoPrestamos.php"><img src="ui/Img/pago.png" id="icons">&nbsp Pago de Prestamos</a></li>
	...
	<div id="contenido">
		<div id="der2.1">
         <h3 id="titulo">Pago De Prestamos</h3>
        
         <br>
         <fieldset id="consign">
         <form id="prestamoForm" name="prestamoForm"role="form" method="Post" action="ui/php/transaccion/prestamos.php">
          <fieldset>
            <legend>Pago Prestamos</legend>
            <?php
            ...
            echo "</select>"; 
                          ?>
               <br>
    			   <label id="lc" >Numero de Prestamo:</label>
   				   <input class="form-control" id="numeroCuenta" name="numeroCuenta" placeholder="Ex: 1000">
             ...
             <input type="password" class="form-control" id="claveV" name="claveV" >  
          </fieldset>
    
 
          <br><br>
  				<button type="submit" class="btn btn-default" id="pagoPrestamo" name="pagoPrestamo">Pago Prestamo</button>
			</form>
      </fieldset>

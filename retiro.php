...
<body>	
    ...
    <div id = "menu">
      <ul class="nav nav-pills">
          <li role="presentation" class="active"><a href="retiro.php"><img src="ui/Img/retiro.png" id="icons">&nbsp Retiro de Dinero</a></li>
	...
	<div id="contenido">
		<div id="der2.1">
			<br>
         <h3 id="titulo">Retiro de Dinero</h3>
        
         <br>
         <fieldset id="retiro">
         <form id="retiroForm" name="retiroForm"role="form" method="Post" action="ui/php/transaccion/retirar.php">
          <fieldset>
          ...
          <br><br>
  				<button type="submit" class="btn btn-default" id="retiroA" name="retiroA">Retiro</button>
			</form>
      </fieldset>

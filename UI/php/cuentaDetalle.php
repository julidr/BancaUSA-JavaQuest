...
<body>	
	...
	<div id = "head">
			...
			<ul class="nav nav-pills">
		  		<li role="presentation" class="active"><a><img src="../Img/consultaEstado.png" id="icons">&nbsp Creditos de Cuenta</a></li>
	...
	<div id = "container">
				...
				<div id="tablaDetalle">
					...
					<table class="table">
						...
						<thead>
								...
								<?php
									$query6="select t3.credito_id, monto_transferencia,fecha_transferencia from transaccion t1 inner join pago_tarjeta t2 on t1.transaccion_id=t2.transaccion_id inner join credito t3 on t2.credito_id=t3.credito_id where t1.cuenta_id=".$_POST["Detalles"]." and tipo_transferencia='pagoTarjeta'";
									$result6=mysqli_query($connection, $query6);
									while ($row6 = mysqli_fetch_assoc($result6)){
										echo "<tr><td><center>".$row6['credito_id']."</center></td>";
					...
					<table class="table">
						...
						<thead>
								...
								<?php
									$query8="select t3.credito_id, monto_transferencia,fecha_transferencia from transaccion t1 inner join pago_prestamo t2 on t1.transaccion_id=t2.transaccion_id inner join credito t3 on t2.credito_id=t3.credito_id where t1.cuenta_id=".$_POST["Detalles"]." and tipo_transferencia='pagoPrestamo'";
									$result8=mysqli_query($connection, $query8);
									while ($row8 = mysqli_fetch_assoc($result8)){
										echo "<tr><td><center>".$row8['credito_id']."</center></td>";
			...
			<center><button type='submit' name='Mas detalles' onclick="location.href='consulta cuenta.php'">Volver a Mis Cuentas</button></center>
		<div id="bot">
			<hr>

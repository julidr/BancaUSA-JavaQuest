...
<body>	
  <div id = "head">
      ...
      <ul class="nav nav-pills">
              <li role="presentation" class="active"><a href="consignacion.php"><img src="ui/Img/consignacion.png" id="icons">&nbsp Consignacion</a></li>
	...
	<div id="contenido">
		<div id="der2.1">
         <h3 id="titulo">Consignación</h3>
        
         <br>
         <fieldset id="consign">
         <form id="consignaForm" name="consignaForm"role="form" method="Post" action="ui/php/transaccion/consignar.php">
          <fieldset>
            <legend>Consignar</legend>
            <?php
          ...
          <br><br>
  				<button type="submit" class="btn btn-default" id="consignaA" name="consignaA">Consignar</button>
			</form>
      </fieldset>
